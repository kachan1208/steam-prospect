...
--                   floor). CAVEAT: read it against the catalog norm, not 1.0 alone — the
--                   catalog-median tag sits at ~0.79 since the 2026-09-22 population fixes
--                   (Early Access graduates dated from their EA launch, free games out of
--                   revenue; it was ~1.08 before). OPP_ENTRANT_NORM in build_marts.py is
--                   re-fitted to it.
