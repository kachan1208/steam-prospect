...
// Account/API-key/usage endpoints were removed with the Settings rework — this is a free,
// login-less tool, so there is no org, plan, key, or per-user usage to manage.
